...
MainActivity extends BaseActivity implements ConversationListner {
...
//show user name in top
    ...
    private void listenConversations(){
        database.collection(Constants.KEY_COLLECTIOM_CONVERSATIONS)
...
//firebase token
    ...
    private void signOut(){
        ...
        documentReference.update(updates)
                ...
                .addOnFailureListener(e -> showToast("Unable to Sign"));
    }
